...
CREATE TABLE IF NOT EXISTS AUTORISATION (id_project INTEGER UNIQUE NOT NULL, date_demande DATE, date_commission DATE, decision VARCHAR(10), date_paiment DATE,date_sign DATE);
