...
export default function ConsultationScreen({route}:any) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Tab.Navigator>
          <Tab.Screen name="BOQClient" component={TotalArticleConsumeComponent} 
           options={{...commonTopBarOptions,
            tabBarLabel: props => <Text {...props} >Rapport</Text> 
          }}
          initialParams={{ 
            project:project
          }}
