...
import ProjectSuivieFinancierOverView from '../components/ProjectSuivieFinancierOverView';
...
const ListProjectSuivieFinancierOverViews =  observer(({route,navigation}:any) => {
            ...
            <View style={{flex: 1,}}>
                ...
                <SectionList sections={[{title:"",data:projectObjectStore.getCategorie(step,categorie)}]}
                 renderItem={({item}:{item:Project}) =>{ 
                         return(
                              <ProjectSuivieFinancierOverView key={key} item = {item} navigation={navigation}
...
export default ListProjectSuivieFinancierOverViews;
